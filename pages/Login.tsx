  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-slate-900 relative overflow-hidden font-sans">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
             ...
             <div className="absolute top-[-20%] right-[-10%] w-[800px] h-[800px] bg-[#2c92d5]/20 rounded-full blur-[120px]"></div>
      ...
      <div className="w-full max-w-md z-10 px-6">
        ...
        <div className="flex flex-col items-center mb-8">
            <div className="w-16 h-16 bg-[#2c92d5] rounded-2xl flex items-center justify-center mb-6 shadow-2xl shadow-[#2c92d5]/50 transform rotate-3 border border-white/10">
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          {/* Status Bar */}
          <div className="h-1.5 w-full bg-gradient-to-r from-[#2c92d5] via-blue-400 to-[#2c92d5]"></div>
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <div className="absolute left-0 top-0 bottom-0 w-10 flex items-center justify-center text-slate-400 group-focus-within:text-[#2c92d5] transition-colors">
                      <User size={18} />
                  </div>
                  <input
                    type="text"
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-white border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2c92d5]/50 focus:border-[#2c92d5] transition-all text-slate-900 font-medium placeholder-slate-400"
              ...
              <div className="pt-4 flex gap-3">
                ...
                <button
                  type="submit"
                  className="flex-[2] bg-[#2c92d5] hover:bg-[#237ab3] text-white font-bold py-3.5 rounded-lg shadow-lg shadow-[#2c92d5]/20 hover:shadow-xl transition-all duration-200 flex items-center justify-center gap-2 group"
                >
                  Đăng nhập
